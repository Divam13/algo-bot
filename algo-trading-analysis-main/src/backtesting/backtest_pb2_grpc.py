...
class BacktestServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RunBacktest = channel.unary_unary(
                '/alpha_engine.BacktestService/RunBacktest',
                request_serializer=backtest__pb2.BacktestRequest.SerializeToString,
                response_deserializer=backtest__pb2.BacktestResponse.FromString,
...
def add_BacktestServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RunBacktest': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=backtest__pb2.BacktestResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'alpha_engine.BacktestService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('alpha_engine.BacktestService', rpc_method_handlers)
...
class BacktestService(object):
    ...
    def RunBacktest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            backtest__pb2.BacktestResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
